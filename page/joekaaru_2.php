...
//tulemuse salvestamine	
	...
	if(	$basket_error == ""){
				...
				$msg = saveJoekaaru($_GET["k"],$basket);
				
				if($msg != ""){
					
					if($_GET["k"] == "18"){
						header("Location: joekaaru_final.php");
						var_dump($_GET["k"]);
						exit();
					}
					$k = $_GET["k"]+1;
					header("Location: joekaaru_2.php?k=".$k);
...
<h2><?=$_GET["k"];?>. korv</h2>
  <form action="joekaaru_2.php?k=<?php echo $_GET["k"]; ?>" method="post" >
