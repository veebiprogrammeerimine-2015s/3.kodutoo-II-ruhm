...
class User {
	...
	function createUser($create_email, $password_hash){
		...
		$stmt = $this->connection->prepare("SELECT email FROM user_kd WHERE email = ?");
		...
		$stmt = $this->connection->prepare("INSERT INTO user_kd (email, password) VALUES (?, ?)");
	...
	function loginUser($email, $password_hash){
		...
		$stmt = $this->connection->prepare("SELECT id, email FROM user_kd WHERE email=? AND password=?");
